                ...
                <div className='w-full text-center mx-auto'>
                    <span onClick={
                        () => {
                            ...
                            dispatch(FeatureAction.Show_iSModalSittings(true));
                        }
                    }
                        className='block cursor-pointer text-red-600 font-bold py-4 hover:bg-gray-100'>Block</span><hr />
                    ...
                    <span onClick={
                        () => {
                            ...
                            dispatch(FeatureAction.Show_iSModalSittings(true))
                        }} className='block cursor-pointer text-red-600 font-bold py-4 hover:bg-gray-100'>Report</span><hr />
                    <span className='block cursor-pointer focus:bg-gray-500 py-4 hover:bg-gray-100'
                        onClick={() => dispatch(FeatureAction.Show_iSModalSittings(false))} >Cancel</span>
                </div>
            </motion.div>
