...
import { ReelsApi, useGetUserByIdReelsQuery } from '../../../Redux/APIs/ReelsApi';
        ...
        <>
            ...
            <div className='fixed inset-0 bg-[#1A1A1A]'>
                <Swiper
                    ...
                    className="flex justify-center items-center max-w-3xl h-[100dvh] container px-0 cursor-pointer text-white"
                >
                    {isFetching ?
                        <SwiperSlide className='h-[100dvh] bg-zinc-800 animate-pulse relative w-full'>
                            <SkilReelVideo />
                        </SwiperSlide>
