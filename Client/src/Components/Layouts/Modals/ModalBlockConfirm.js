...
const ModalBlockConfirm = ({ UserByIdDetails }) => {
    const dispatch = useDispatch();

    const [Block] = useBlockMutation();
    const BlockHandler = async () => {
        const id = UserByIdDetails._id
        ...
        <>
            ...
            >
                ...
                <div className='text-center space-y-3 py-4 '>
                    <p className='text-lg flex justify-center font-medium mt-2'>Block {UserByIdDetails?.username} ?</p>
