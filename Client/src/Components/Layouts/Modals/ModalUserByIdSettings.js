...
const ModalUserByIdSettings = ({ id }) => {
    ...
    const BlockHandler = async () => {
        await Block(id).unwrap()
            .then(payload => dispatch(FeatureAction.Show_iSModalSittings(false)))
        ...
        <>
            ...
            >
                <div className='w-full text-center mx-auto'>
                    <span onClick={BlockHandler} className='block cursor-pointer text-red-600 font-bold py-4 hover:bg-gray-100'>Block</span><hr />
