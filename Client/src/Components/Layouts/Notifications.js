    ...
    return (
        <motion.div
            ...
            {result?.map(res => (
                ...
                >
                    <img className="p-1 w-20 h-20 object-cover rounded-full focus:ring-2 focus:ring-gray-300" src={res?.avatar?.url ? res?.avatar?.url: process.env.REACT_APP_DefaultIcon} alt="" />
                    <div className='ml-2'>
