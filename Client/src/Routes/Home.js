...
const Home = () => {
  ...
  return (
    <div>
      ...
      <SideBar />
      <div className='container px-0 max-w-5xl md:max-w-3xl xl:max-w-3xl xxl:max-w-5xl py-3 mt-16 lg:mt-0 lg:mr-10 xl:mr-60 xxxl:mr-[26rem]'>
        <div className='lg:grid lg:grid-cols-5 gap-3 duration-300 xl:mt-10'>
